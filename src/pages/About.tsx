...
const values = [
  ...
  },
  {
    icon: Award,
    title: "ISO 9001 인증",
    desc: "실리카의 현지 공장은 글로벌 업체들에게 원료을 공급하고 있는 오랜 경험과 축적된 기술력을 기반으로 ISO 9001,ISO 22000 등의 품질 관리 시스템과 작업 환경을 보유 하고 있습니다. 지속적으로 발전 하는 기술의 빠른 적용을 통하여 전자 소재 · 산업용 코팅 · 세라믹 · 내화재 · 주조 · 태양광 및 에너지 소재 및 각종 실리카 첨가물을 다양한 산업분야 전반에 최적의 실리카 솔루션을 제공합니다.",
  },
  {
    icon: Globe2,
    title: "글로벌 파트너십",
